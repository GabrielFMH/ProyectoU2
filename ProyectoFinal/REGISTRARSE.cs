...
namespace Proyecto_Final_Blood_Bank
{
	...
	0x748f82ee,0x78a5636f,0x84c87814,0x8cc70208,0x90befffa,0xa4506ceb,0xbef9a3f7,0xc67178f2
		...
		private Rectangle ReclblRegistrese;
		private Rectangle ReclblNo;
		private Rectangle ReclblCrear;
		private Rectangle ReclblConfirmar;
		private Rectangle RectxtConfirmar;
		...
		private void REGISTRARSE_Load(object sender, EventArgs e)
        {
			...
			RecRegister = new Rectangle(btnRegister.Location.X, btnRegister.Location.Y, btnRegister.Width, btnRegister.Height);
			...
			ReclblRegistrese = new Rectangle(lblRegistrese.Location.X, lblRegistrese.Location.Y, lblRegistrese.Width, lblRegistrese.Height);
			ReclblConfirmar = new Rectangle(lblConfirmar.Location.X, lblConfirmar.Location.Y, lblConfirmar.Width, lblConfirmar.Height);
			RectxtConfirmar = new Rectangle(txtConfirm.Location.X, txtConfirm.Location.Y, txtConfirm.Width, txtConfirm.Height);
        ...
        private void REGISTRARSE_Resize(object sender, EventArgs e)
        {
			resizeControl(RecRegister, btnRegister);
			...
			resizeControl(ReclblRegistrese, lblRegistrese);
			resizeControl(ReclblCrear, lblCrear);
			resizeControl(ReclblNo, lblNo);
			resizeControl(ReclblConfirmar, lblConfirmar);
			resizeControl(RectxtConfirmar, txtConfirm);
		}
